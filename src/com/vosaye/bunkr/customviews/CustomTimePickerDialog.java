...
public class CustomTimePickerDialog extends TimePickerDialog {
    ...
    private int minMinute = 0, minHour = 0, maxMinute = 59, maxHour = 23;
    ...
    public CustomTimePickerDialog(Context context, OnTimeSetListener callBack,
            int hourOfDay, int minute, boolean is24HourView, boolean isCustom,int minMinute, int minHour, int maxMinute, int maxHour) {
        super(context, callBack, hourOfDay, minute / TIME_PICKER_INTERVAL,
                is24HourView);
        this.callback = callBack;
    ...
    public void onAttachedToWindow() {
        ...
        try {
            ...
            NumberPicker mHourSpinner = (NumberPicker) timePicker
                    .findViewById(fieldh.getInt(null));
            if(isCustom){
